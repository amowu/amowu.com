...
export const dialogues = {
  ...
  n10002: {
    ...
    next: {
      kind: 'options',
      items: [
        { label: '打開履歷表', next: { kind: 'route', to: '/resume' } },
        { label: '結束對話', next: { kind: 'dialogue', id: 'n10003' } },
      ],
    },
  },
  n10003: {
  ...
  n10006: {
    ...
    next: {
      kind: 'options',
      items: [
        { label: '你是誰？', next: { kind: 'dialogue', id: 'n10007' } },
        { label: '好！😋', next: { kind: 'dialogue', id: 'n10008' } },
        { label: '我只是來發個 Issue 的', next: { kind: 'dialogue', id: 'n10009' } },
        { label: '很明顯我就是那個人，但 GitHub 是啥？', next: { kind: 'dialogue', id: 'n10010' } },
        { label: '結束對話', next: { kind: 'dialogue', id: 'n10011' } },
      ],
    },
  },
  n10007: {
    ...
    next: {
      kind: 'options',
      items: [
        { label: '好吧，然後咧？', next: { kind: 'dialogue', id: 'n10006' } },
        { label: '你是國王？那我不就你皇祖母', next: { kind: 'dialogue', id: 'n10011' } },
      ],
    },
  },
  n10008: {
    ...
    next: {
      kind: 'options',
      items: [
        { label: '打開 GitHub Repo', next: { kind: 'url', href: 'https://github.com/amowu/amowu.com' } },
        { label: 'GitHub 是啥？', next: { kind: 'dialogue', id: 'n10011' } },
        { label: '離開對話', next: { kind: 'dialogue', id: 'n10011' } },
      ],
    },
  },
  n10009: {
    text: '<p>⋯⋯前方右轉不送<i class="external icon"></i>🙄</p>',
    next: { kind: 'url', href: 'https://github.com/amowu/amowu.com/issues' },
  },
  n10010: {
    text: '<p>⋯⋯很明顯你不是。😒</p>',
    next: { kind: 'close' },
  ...
  n10012: {
    ...
    next: {
      kind: 'options',
      items: [
        { label: '什麼是鄉民證？', next: { kind: 'dialogue', id: 'n10013' } },
        { label: '結束對話', next: { kind: 'close' } },
      ],
    },
  },
  n10013: {
    ...
    next: {
      kind: 'options',
      items: [
        { label: '村長家在哪？', next: { kind: 'dialogue', id: 'n10014' } },
        { label: '我知道了', next: { kind: 'close' } },
      ],
    },
  },
  n10014: {
  ...
  n10017: {
    ...
    next: {
      kind: 'options',
      items: [
        { label: '你好，請問這裡是哪呢？', next: { kind: 'dialogue', id: 'n10018' } },
        { label: '你在這裡做什麼呢？', next: { kind: 'dialogue', id: 'n10019' } },
        { label: '結束對話', next: { kind: 'dialogue', id: 'n10020' } },
      ],
    },
  },
  n10018: {
  ...
  n10021: {
    ...
    next: {
      kind: 'options',
      items: [
        { label: '雲杉洞穴是？', next: { kind: 'dialogue', id: 'n10022' } },
        { label: '結束對話', next: { kind: 'dialogue', id: 'n10023' } },
      ],
    },
  },
  n10022: {
