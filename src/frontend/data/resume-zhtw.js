...
export default {
  'basics': {
    ...
    'picture': 'https://www.gravatar.com/avatar/778858b33950746e7049bfc33e94ac50',
    'email': 'barry800414@gmail.com',
    'phone': '+886-930986663',
    'website': 'https://wei-ming.tw',
    'blog': 'https://blog.wei-ming.tw',
  ...
  'works': [{
    'position': '資深程式設計師',
    'picture': 'https://cdn.amowu.com/1c35290.png',
    ...
    'projects': [{
      ...
      'skills': [
        { 'color': 'black', 'name': 'Flex' },
        { 'color': 'red', 'name': 'Flash' },
        { 'color': 'red', 'name': 'ActionScript 3.0' },
        { 'name': 'PureMVC' },
        { 'name': 'Amfphp' },
        { 'name': 'PHP' },
        { 'name': 'MySQL' },
      ...
      'picture': 'https://cdn.amowu.com/brXTjMsBCR7SjzZfikMWc6uluM0.jpeg',
      'startDate':
      '2012-08',
      'name': '末日少女',
      'medias': [
        { 'url': 'http://xd.age-corp.jp/dmm/', 'network': 'website' },
        { 'url': 'https://www.youtube.com/watch?v=3URpSS73xlY', 'network': 'YouTube' },
        { 'url': 'https://twitter.com/zombigirl_kari', 'network': 'Twitter' }
      ],
      'endDate': '2013-07'
    }, {
      'summary': "<p>《Gu Morning 早安咕咕》是一款結合《俄羅斯方塊》要素的益智類型手機遊戲。</p><p>這是我在<mark>新人試用期間負責的專案</mark>，因為主管希望可以降低手機遊戲跨平台的開發成本，所以首次嘗試讓我研究 HTML5 的相關技術。</p><p>在 HTML5 還不成熟的初期階段踩了不少坑，也因此讓我在 JavaScript 的技術上獲得很大的成長，並在<mark>三個月的時間內快速交付出原型</mark>，最後經過大家的努力成功讓《Gu Morning 早安咕咕》在 iOS 與 Android 平台上市，並<mark>成為部門第一款擁有收入來源的產品</mark>。</p><p>在 HTML5 game engine 資源還很缺乏的時期，花了很多精力在尋找合適的方案與<mark>學習如何參與開源社群</mark>，最後找到了 <a href='https://github.com/aduros/hydra' target='_blank'>Hydra</a> 這款簡單的 HTML5 game engine，並且在使用 <a href='https://github.com/google/closure-compiler' target='_blank'>Google Closure Compiler</a> 當中學習到組織大量 JavaScript 程式碼的技巧。</p><p>為了跨平台，我們使用了 PhoneGap 將 HTML5 運行在 iOS 與 Android 的 WebView 元件上，因為 DOM render 的效能不如原生應用，之後的專案《Gu Morning 早安咕咕 2》引以為鑒，改採 Canvas render 的方式開發，<mark>效能獲得大幅提升</mark>。</p>", 'skills': [{ 'color': 'orange', 'name': 'HTML5' }, { 'color': 'blue', 'name': 'CSS3' }, { 'color': 'yellow', 'name': 'JavaScript' }, { 'name': 'Hydra' }, { 'name': 'Google Closure Compiler' }, { 'name': 'PhoneGap' }, { 'name': 'SVN' }], 'picture': 'https://cdn.amowu.com/EFSTFWfYlPmWEw5ovcrU3JJ8eM4.jpeg', 'startDate': '2011-05', 'name': 'Gu Morning 早安咕咕', 'medias': [{ 'url': 'https://itunes.apple.com/us/app/gu-morning/id474441856?ls=1&mt=8', 'network': 'iOS' }, { 'url': 'https://play.google.com/store/apps/details?id=com.gamania.gumorning', 'network': 'Android' }, { 'url': 'http://corp.gamania.com/mobilegame/gumorning/ch/index.html', 'network': 'website' }, { 'url': 'https://www.youtube.com/watch?v=RULZzZxLl5U', 'network': 'YouTube' }, { 'url': 'http://www.slideshare.net/AMO26/javascript-62068889', 'network': 'SlideShare' }, { 'url': 'http://www.slideshare.net/AMO26/gumorning', 'network': 'SlideShare' }], 'endDate': '2012-01' }, { 'summary': '<p>算上其它未上市的產品，我在遊戲橘子一共參與過 7 件專案的開發（Facebook Social Game x 2、Mobile Game x 4、Web Game x 1），大部分都是負責 Client 端的程式設計，擁有豐富的 UI & UX 實作經驗。晉升資深程式設計師之後，獲得一次帶領團隊的機會，並以《末日少女》的經驗，協助新團隊建置適合 Unity 的 Client & Server 架構，並在 DevOps 還未盛行的時期就<mark>引入 Git flow 與 Jenkins 來達成 CI & CD 的自動化環境，提升整體開發效率，獲得主管與成員們的讚賞</mark>。</p>',
      'skills': [
        { 'name': 'Unity' },
        { 'name': 'C#' },
        { 'name': 'SQLite' },
  ...
  'educations': [
    {
      'picture': 'https://cdn.amowu.com/015e2ec.png',
      ...
      'projects': [{
        ...
        'picture': 'https://cdn.amowu.com/tAjv.jpeg',
        'startDate': '2012-08',
        'name': 'Little March',
        'medias': [
            { 'url': 'https://www.youtube.com/watch?v=SUjawFj702M', 'network': 'YouTube' },
            { 'url': 'http://www.slideshare.net/AMO26/ss-62068992', 'network': 'SlideShare' },
            { 'url': 'http://www.slideshare.net/AMO26/097-csies017', 'network': 'SlideShare' }
        ],
        'endDate': '2013-07'
      }, {
        ...
        'picture': 'https://cdn.amowu.com/QIPZJIrPMnx6OZcrI7d6g82xZeE.jpeg',
        'startDate': '2011-05',
        'name': 'Metal Slug 魂斗羅',
        'medias': [
          { 'url': 'https://www.youtube.com/watch?v=7dOJZarg9TA', 'network': 'YouTube' },
          { 'url': 'http://www.slideshare.net/AMO26/ss-62069037', 'network': 'SlideShare' }
        ],
        'endDate': '2012-01'
      }, {
        'skills': [
      ...
      'endDate': '2009-06-20',
      'highlights': [
        '擔任應用英文系工讀生，負責系上網頁架設與維護、英文單字互動遊戲活動的程式設計。', '擔任學生輔導中心工讀生，負責活動網頁的設計、動畫製作等工作。'
      ],
      'institution': '國立台北科技大學'
    }],
  'skills': [{
    'keywords': [{ 'name': 'HTML' }, { 'name': 'CSS',
      'highlights': ['Bootstrap, Semantic UI, Material Design UI, ...']
      }, {
        'name': 'JavaScript',
        'highlights': ['Node.js, ECMAScript2015, AngularJS, React & Redux, Vue.js & Vuex, ...'] }
      ], 'name': 'Front-End Web Development'
  },
  {
    'keywords': [
      { 'name': 'Flash', 'highlights': ['Flex, ActionScript 3.0, ...'] },
      { 'name': 'Unity' },
      { 'name': 'HTML5', 'highlights': ['ImpactJS, Phaser, ...'] }
    ],
    'name': 'Game Development'
  }, {
    'keywords': [
      { 'name': 'XaaS', 'highlights': ['Amazon Web Services, Google Cloud Platform, ...', 'Heroku, Parse, Firebase, ...'] },
      { 'name': 'Back-End Development', 'highlights': ['RESTful APIs', 'Relational & NoSQL Database', 'Serverless & Microservice'] }
    ],
    'name': 'Cloud Computing'
  }, {
    'keywords': [
      { 'name': 'Continuous Integration & Continuous Delivery', 'highlights': ['Jenkins, CircleCI, ...'] },
      { 'name': 'Infrastructure as Code', 'highlights': ['Docker, Vagrant, Terraform, ...'] },
      { 'name': 'Git & GitHub workflow', 'highlights': ['Git Flow, Pull Requst, Code Review, Issue Tracking, ...'] },
      { 'name': 'Code Quality', 'highlights': ['Coding Style, Unit & E2E Testing, Code Coverage, ...', 'Yeoman, Grunt, Gulp, Webpack, Babel, ...'] }
    ],
    'name': 'DevOps' }
  ],
  'projects': {
